    ...
    >
      ...
      >
        <div className="bsr-sat">
          ...
          >
            {/* Solar panel left */}
            <rect x="0" y="5" width="5" height="6" rx="0.5" fill="var(--bsr-signal, #ffb454)" opacity="0.85" />
            ...
            <circle cx="8" cy="7" r="1.2" fill="var(--bsr-phosphor, #28e0c6)" opacity="0.9" />
            <rect x="6.5" y="10" width="3" height="1.5" rx="0.3" fill="#8a97a3" />
            {/* Solar panel right */}
            <rect x="11" y="5" width="5" height="6" rx="0.5" fill="var(--bsr-signal, #ffb454)" opacity="0.85" />
