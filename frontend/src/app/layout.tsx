...
export const metadata: Metadata = {
  title: "BharatSR — Satellite Imagery Super-Resolution",
  description: "Physics-constrained deep learning super-resolution mapping for medium-resolution satellite imagery — SIH26142 (NTRO)",
};
